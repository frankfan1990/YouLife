...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    static NSString *cellName = @"cell_beauty";
    BeautyTableViewCell *cell =[tableView dequeueReusableCellWithIdentifier:cellName];
    if(!cell){
    
        cell =[[BeautyTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellName];
    }
